...
public class QuanLyBanAn_Dialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rdoBanTrong.setText("Có khách");

        TrangThaiBanAn.add(rdoCoKhach);
        rdoCoKhach.setText("Bàn trống");
        ...
        jTabbedPane1.addTab("Có khách", jPanel4);
        ...
        jTabbedPane1.addTab("Bàn trống", jPanel5);
        ...
        for (BanAn banAn : list) {
            if (banAn.isTrangThai()) {
                Object[] row = new Object[]{
                    banAn.getMaBanAn(),
                    banAn.getTenBan(),
                    banAn.isTrangThai() ? "Có khách" : "Bàn trống",
                    banAn.getMaKhuVuc()
                };
                model.addRow(row);
            }
