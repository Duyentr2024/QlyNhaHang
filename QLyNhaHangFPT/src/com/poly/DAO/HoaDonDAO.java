...
public class HoaDonDAO {
   ...
   public List<HoaDon> selectByMaBanAn(String maBanAn) {
    String sql = "SELECT * FROM HoaDon WHERE MaBanAn=?";
    return select(sql, maBanAn);
}

   
   public HoaDon selectByMaBanAns(String maBanAn) {
    String sql = "SELECT * FROM HoaDon WHERE MaBanAn = ?";
